...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/produit')) {
            ...
            if (0 === strpos($pathinfo, '/produit/modifier') && preg_match('#^/produit/modifier/(?P<codebarre>[^/]++)$#s', $pathinfo, $matches)) {
            ...
            if (0 === strpos($pathinfo, '/produit/supprimer') && preg_match('#^/produit/supprimer/(?P<codebarre>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/categorie')) {
            ...
            if (0 === strpos($pathinfo, '/categorie/modifer') && preg_match('#^/categorie/modifer/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            ...
            if (0 === strpos($pathinfo, '/categorie/supprimer') && preg_match('#^/categorie/supprimer/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            ...
            if (0 === strpos($pathinfo, '/categorie/produit') && preg_match('#^/categorie/produit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
