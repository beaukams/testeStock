...
class __TwigTemplate_6113613ce6c7422f18bb3c9da88d4f05665d4bcd81adc1909d29ff069592e671 extends Twig_Template
{
...
\t\t    ";
        // line 10
        echo "\t\t    ";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulaire"]) ? $context["formulaire"] : null), "produitTemp", array()), 'label', array("label_attr" => array("class" => "col-sm-4 control-label"), "label" => "Produit : "));
        echo "

\t\t    ";
        // line 13
        echo "\t\t    ";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulaire"]) ? $context["formulaire"] : null), "produitTemp", array()), 'errors');
        echo "
...
\t\t        ";
        // line 17
        echo "\t\t        ";
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulaire"]) ? $context["formulaire"] : null), "produitTemp", array()), 'widget', array("attr" => array("class" => "form-control")));
        echo "
\t\t    </div>
\t\t</div>
...
\t\t";
        ...
        // line 51
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulaire"]) ? $context["formulaire"] : null), "Annuler", array()), 'widget', array("attr" => array("class" => "btn btn-primary")));
        echo "</span>
...
\t";
    ...
    {
        return array (  126 => 54,  122 => 53,  117 => 51,  111 => 49,  102 => 43,  95 => 39,  89 => 36,  80 => 30,  73 => 26,  67 => 23,  58 => 17,  51 => 13,  45 => 10,  40 => 7,  36 => 6,  31 => 3,  28 => 2,  11 => 1,);
    }
}
